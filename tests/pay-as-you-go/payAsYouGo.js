...
class PayAsYouGo {
    ...
    async fillPayAsYouGoForm() {
        await this.page.waitForSelector(e.contractName);
        await this.page.click(e.contractName);
        await this.page.type(e.contractName, v.CONTRACT_NAME_PAY_AS_YOU_GO);
        ...
        await this.page.keyboard.type('This is a Pay As You Go Scope of Work entry!');
        ...
        await this.page.keyboard.type('Week');
        await this.page.keyboard.press('Tab');
